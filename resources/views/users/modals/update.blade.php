<div class="modal fade in" id="updateUserModal" tabindex="-1" role="dialog" style="display: none; padding-left: 17px;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['url' => '/', 'id' => 'updateUserForm']) !!}
                {!! Form::hidden('id', null) !!}
                <div class="row">
                    <div class="col-sm-12">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-link waves-effect" onclick="updateUser()">Atualizar</button>
